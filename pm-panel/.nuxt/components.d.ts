...
export const ChatActiveResponse: typeof import("../components/chat/ChatActiveResponse.vue").default
export const ChatInput: typeof import("../components/chat/ChatInput.vue").default
export const ChatMessage: typeof import("../components/chat/ChatMessage.vue").default
export const ChatSidebar: typeof import("../components/chat/ChatSidebar.vue").default
export const TasksKanbanBoard: typeof import("../components/tasks/KanbanBoard.vue").default
export const TasksKanbanColumn: typeof import("../components/tasks/KanbanColumn.vue").default
export const TasksKanbanTaskCard: typeof import("../components/tasks/KanbanTaskCard.vue").default
export const TasksTaskViewToggle: typeof import("../components/tasks/TaskViewToggle.vue").default
...
export const LazyChatActiveResponse: LazyComponent<typeof import("../components/chat/ChatActiveResponse.vue").default>
export const LazyChatInput: LazyComponent<typeof import("../components/chat/ChatInput.vue").default>
export const LazyChatMessage: LazyComponent<typeof import("../components/chat/ChatMessage.vue").default>
export const LazyChatSidebar: LazyComponent<typeof import("../components/chat/ChatSidebar.vue").default>
export const LazyTasksKanbanBoard: LazyComponent<typeof import("../components/tasks/KanbanBoard.vue").default>
export const LazyTasksKanbanColumn: LazyComponent<typeof import("../components/tasks/KanbanColumn.vue").default>
export const LazyTasksKanbanTaskCard: LazyComponent<typeof import("../components/tasks/KanbanTaskCard.vue").default>
export const LazyTasksTaskViewToggle: LazyComponent<typeof import("../components/tasks/TaskViewToggle.vue").default>
