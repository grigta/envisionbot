...
interface _GlobalComponents {
  ...
  'ChatActiveResponse': typeof import("../../components/chat/ChatActiveResponse.vue").default
  ...
  'TasksKanbanBoard': typeof import("../../components/tasks/KanbanBoard.vue").default
  'TasksKanbanColumn': typeof import("../../components/tasks/KanbanColumn.vue").default
  'TasksKanbanTaskCard': typeof import("../../components/tasks/KanbanTaskCard.vue").default
  'TasksTaskViewToggle': typeof import("../../components/tasks/TaskViewToggle.vue").default
  ...
  'LazyChatActiveResponse': LazyComponent<typeof import("../../components/chat/ChatActiveResponse.vue").default>
  'LazyChatInput': LazyComponent<typeof import("../../components/chat/ChatInput.vue").default>
  'LazyChatMessage': LazyComponent<typeof import("../../components/chat/ChatMessage.vue").default>
  'LazyChatSidebar': LazyComponent<typeof import("../../components/chat/ChatSidebar.vue").default>
  'LazyTasksKanbanBoard': LazyComponent<typeof import("../../components/tasks/KanbanBoard.vue").default>
  'LazyTasksKanbanColumn': LazyComponent<typeof import("../../components/tasks/KanbanColumn.vue").default>
  'LazyTasksKanbanTaskCard': LazyComponent<typeof import("../../components/tasks/KanbanTaskCard.vue").default>
  'LazyTasksTaskViewToggle': LazyComponent<typeof import("../../components/tasks/TaskViewToggle.vue").default>
