...
export class SWOTGenerator {
    ...
    async generate(domain, pages, techStack, seoAnalysis, structureAnalysis) {
    ...
    buildPrompt(domain, pages, techStack, seoAnalysis, structureAnalysis) {
...
export async function generateSWOT(domain, pages, techStack, seoAnalysis, structureAnalysis, options) {
...
//# sourceMappingURL=swot-generator.js.map