 ...
 */
export function getRandomUserAgent(type = 'desktop') {
 ...
 */
export function parseProxyList(proxyString) {
    if (!proxyString)
        return [];
    return proxyString
        .split(',')
 ...
 */
export function createProxyConfiguration(config) {
 ...
 */
export async function withDelay(fn, minDelay, maxDelay) {
 ...
 */
export function getCommonHeaders(userAgent) {
    return {
 ...
 */
export function getRefererForDomain(domain) {
 ...
 */
export function isUrlAllowed(url, rules) {
    try {
...
export class RateLimiter {
    ...
    constructor(minDelay, maxDelay, maxRequestsPerMinute) {
