...
export class TaskExecutorService {
  constructor(
    ...
    private planTracker: PlanTrackerService
  ) {}
...
`.trim();
   ...
   */
  private async commitTaskCompletion(
    task: Task,
   ...
   */
  private buildCommitMessage(task: Task, result: TaskExecutionResult): string {
    // Determine commit type prefix based on task type
    const commitTypeMap: Record<Task["type"], string> = {
      development: "feat",
      review: "refactor",
      planning: "docs",
      maintenance: "chore",
