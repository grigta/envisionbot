 ...
 */
export async function crawlItemDetails(item) {
 ...
 */
export async function convertToNewsItem(item, fetchDetails = false) {
    const now = Date.now();
    const newsItem = {
        ...item,
 ...
 */
export async function convertItemsBatch(items, fetchDetails = false, onProgress) {
    const results = [];
