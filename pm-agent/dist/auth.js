...
export function getAuthConfig() {
    ...
    throw new Error("No Anthropic API key found. Set ANTHROPIC_API_KEY, CLAUDE_CODE_OAUTH_TOKEN, or login to Claude Code.");
}
/**
...
function getTokenFromKeychain() {
    ...
    try {
        ...
        const rawCredentials = execSync('security find-generic-password -s "Claude Code-credentials" -w 2>/dev/null', { encoding: "utf-8" }).trim();
